...
- **Wordpress.com** seems very promising as our website host. 
- It costs less than $500+ per year.
- It’s widely used (more than 40% of all websites).
...
- a [public repository for the AccelRR8 Body of Knowledge](https://github.com/AccelRR8-Consortium-NonProfit/ABOK)
- a [public repository for our website](https://github.com/AccelRR8-Consortium-NonProfit/Website), and
- [private](https://github.com/AccelRR8-Consortium-NonProfit/Management-Private) and [public](https://github.com/AccelRR8-Consortium-NonProfit/Management-Public) repositories for AccelRR8 Consortium Management.

- **Github** was easy to set up
- It’s working well for curation and open-source-like collaboration on our AccelRR8 BOK
- It’s widely used by the technology community 
...
- Although **Discord** recently took some brand hits for introducing age verification, it’s a sign of maturity that bodes well for our organization’s use of it
- It looks very promising for private and public topic-based collaboration
- It’s Slack-like without requiring a subscription fee for basic usage
- It’s widely used throughout open source, technology, gaming, and creative communities
...
- But topic-based collaboration will likely be better on Discord
- Here is a link to the [AccelRR8 Consortium NonProfit LinkedIn group](https://www.linkedin.com/groups/12932023/) we had previously set up